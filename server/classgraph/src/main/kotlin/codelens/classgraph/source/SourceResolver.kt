...
class SourceResolver(
    ...
    fun resolveClass(fqn: String): Result<SourceInfo> {
        ...
        val sortedRoots = sourceRoots.sortedWith(compareBy(
    ...
    fun resolveMethod(
        ...
        val extraction = methodExtractor.extractBySignature(
            lines, methodName, method.parameters.map { it.type }, sourceInfo.language
        )
